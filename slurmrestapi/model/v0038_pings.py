...
class V0038Pings(
        ...
        class properties:
            ...
            class pings(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V0038Ping']:
                        return V0038Ping
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V0038Ping'], typing.List['V0038Ping']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'pings':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'V0038Ping':
                    return super().__getitem__(i)
            __annotations__ = {
                "meta": meta,
                "errors": errors,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "pings", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "pings", ], str]):
