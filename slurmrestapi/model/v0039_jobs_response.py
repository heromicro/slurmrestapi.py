...
class V0039JobsResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def jobs() -> typing.Type['V0039JobInfoMsg']:
                return V0039JobInfoMsg
            __annotations__ = {
                "meta": meta,
                "errors": errors,
                "warnings": warnings,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["jobs"]) -> 'V0039JobInfoMsg': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "warnings", "jobs", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["jobs"]) -> typing.Union['V0039JobInfoMsg', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "warnings", "jobs", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        jobs: typing.Union['V0039JobInfoMsg', schemas.Unset] = schemas.unset,
