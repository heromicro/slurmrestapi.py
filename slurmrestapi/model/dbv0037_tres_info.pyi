...
class Dbv0037TresInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errors", "tres", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errors", "tres", ], str]):
