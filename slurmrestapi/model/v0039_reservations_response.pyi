...
class V0039ReservationsResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def reservations() -> typing.Type['V0039ReservationInfoArray']:
                return V0039ReservationInfoArray
            __annotations__ = {
                "meta": meta,
                "errors": errors,
                "warnings": warnings,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reservations"]) -> 'V0039ReservationInfoArray': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "warnings", "reservations", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reservations"]) -> typing.Union['V0039ReservationInfoArray', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "warnings", "reservations", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        reservations: typing.Union['V0039ReservationInfoArray', schemas.Unset] = schemas.unset,
