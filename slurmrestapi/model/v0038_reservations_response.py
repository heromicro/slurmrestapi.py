...
class V0038ReservationsResponse(
        ...
        class properties:
            ...
            class reservations(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V0038Reservation']:
                        return V0038Reservation
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V0038Reservation'], typing.List['V0038Reservation']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'reservations':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'V0038Reservation':
                    return super().__getitem__(i)
            __annotations__ = {
                "meta": meta,
                "errors": errors,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "reservations", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "reservations", ], str]):
