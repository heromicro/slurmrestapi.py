...
class Dbv0037QosInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errors", "qos", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errors", "qos", ], str]):
