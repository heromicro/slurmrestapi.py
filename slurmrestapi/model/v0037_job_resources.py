        ...
        class properties:
            ...
            class allocated_nodes(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V0037NodeAllocation']:
                        return V0037NodeAllocation
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V0037NodeAllocation'], typing.List['V0037NodeAllocation']],
                ...
                def __getitem__(self, i: int) -> 'V0037NodeAllocation':
