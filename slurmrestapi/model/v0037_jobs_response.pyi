...
class V0037JobsResponse(
        ...
        class properties:
            ...
            class jobs(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V0037JobResponseProperties']:
                        return V0037JobResponseProperties
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V0037JobResponseProperties'], typing.List['V0037JobResponseProperties']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'jobs':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'V0037JobResponseProperties':
                    return super().__getitem__(i)
            __annotations__ = {
                "errors": errors,
                "jobs": jobs,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errors", "jobs", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errors", "jobs", ], str]):
