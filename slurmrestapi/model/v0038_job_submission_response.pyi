...
class V0038JobSubmissionResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "job_id", "step_id", "job_submit_user_msg", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "job_id", "step_id", "job_submit_user_msg", ], str]):
