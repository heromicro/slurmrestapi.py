...
class V0039Pings(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def pings() -> typing.Type['V0039ControllerPingArray']:
                return V0039ControllerPingArray
            __annotations__ = {
                "meta": meta,
                "errors": errors,
                "warnings": warnings,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pings"]) -> 'V0039ControllerPingArray': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "warnings", "pings", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pings"]) -> typing.Union['V0039ControllerPingArray', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "warnings", "pings", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        pings: typing.Union['V0039ControllerPingArray', schemas.Unset] = schemas.unset,
