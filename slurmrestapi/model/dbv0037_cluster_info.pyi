        ...
        class properties:
            ...
            class tres(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Dbv0037ResponseTres']:
                        return Dbv0037ResponseTres
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Dbv0037ResponseTres'], typing.List['Dbv0037ResponseTres']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'tres':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Dbv0037ResponseTres':
                    return super().__getitem__(i)
            __annotations__ = {
