...
class Dbv0037AssociationsInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errors", "associations", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errors", "associations", ], str]):
