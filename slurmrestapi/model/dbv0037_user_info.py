...
class Dbv0037UserInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errors", "users", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errors", "users", ], str]):
