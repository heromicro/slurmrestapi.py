...
class V0037PartitionsResponse(
        ...
        class properties:
            ...
            class partitions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V0037Partition']:
                        return V0037Partition
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V0037Partition'], typing.List['V0037Partition']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'partitions':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'V0037Partition':
                    return super().__getitem__(i)
            __annotations__ = {
                "errors": errors,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errors", "partitions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errors", "partitions", ], str]):
