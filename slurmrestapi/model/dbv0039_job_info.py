...
class Dbv0039JobInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def jobs() -> typing.Type['V0039JobList']:
                return V0039JobList
            __annotations__ = {
                "meta": meta,
                "errors": errors,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["jobs"]) -> 'V0039JobList': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["jobs"]) -> typing.Union['V0039JobList', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        jobs: typing.Union['V0039JobList', schemas.Unset] = schemas.unset,
