...
class V0039JobUpdateResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def results() -> typing.Type['V0039JobArrayResponseMsg']:
                return V0039JobArrayResponseMsg
            __annotations__ = {
                "meta": meta,
                "errors": errors,
                "warnings": warnings,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'V0039JobArrayResponseMsg': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "warnings", "results", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> typing.Union['V0039JobArrayResponseMsg', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "errors", "warnings", "results", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        results: typing.Union['V0039JobArrayResponseMsg', schemas.Unset] = schemas.unset,
