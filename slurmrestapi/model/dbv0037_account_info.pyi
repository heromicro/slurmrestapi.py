...
class Dbv0037AccountInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errors", "accounts", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errors", "accounts", ], str]):
