...
SchemaFor200ResponseBodyApplicationJson = Dbv0037ResponseUserDelete
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037ResponseUserDelete
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_delete_user_oapg(
        self,
...
class SlurmdbdDeleteUser(BaseApi):
    ...
    def slurmdbd_delete_user(
        ...
        return self._slurmdbd_delete_user_oapg(
