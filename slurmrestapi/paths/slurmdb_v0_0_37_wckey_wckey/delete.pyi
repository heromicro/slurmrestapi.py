...
SchemaFor200ResponseBodyApplicationJson = Dbv0037ResponseWckeyDelete
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037ResponseWckeyDelete
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_delete_wckey_oapg(
        self,
...
class SlurmdbdDeleteWckey(BaseApi):
    ...
    def slurmdbd_delete_wckey(
        ...
        return self._slurmdbd_delete_wckey_oapg(
