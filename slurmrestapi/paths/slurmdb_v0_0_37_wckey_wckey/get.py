...
SchemaFor200ResponseBodyApplicationJson = Dbv0037WckeyInfo
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037WckeyInfo
...
class SlurmdbdGetWckey(BaseApi):
    ...
    def slurmdbd_get_wckey(
        ...
        return self._slurmdbd_get_wckey_oapg(
