...
SchemaFor200ResponseBodyApplicationJson = V0037Diag
SchemaFor200ResponseBodyApplicationXYaml = V0037Diag
...
class SlurmctldDiag(BaseApi):
    ...
    def slurmctld_diag(
        ...
        return self._slurmctld_diag_oapg(
