...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'signal': typing.Union[SignalSchema, str, ],
    },
    total=False
)
...
request_query_signal = api_client.QueryParameter(
    name="signal",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurm_v0039_cancel_job_oapg(
        self,
...
class SlurmV0039CancelJob(BaseApi):
    ...
    def slurm_v0039_cancel_job(
        ...
        return self._slurm_v0039_cancel_job_oapg(
