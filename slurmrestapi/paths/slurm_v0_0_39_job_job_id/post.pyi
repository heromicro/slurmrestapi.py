...
# body param
SchemaForRequestBodyApplicationJson = V0039JobDescMsg
SchemaForRequestBodyApplicationXYaml = V0039JobDescMsg


request_body_v0039_job_desc_msg = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = V0039JobUpdateResponse
SchemaFor200ResponseBodyApplicationXYaml = V0039JobUpdateResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurm_v0039_update_job_oapg(
        self,
    ...
    def _slurm_v0039_update_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_v0039_job_desc_msg.serialize(body, content_type)
...
class SlurmV0039UpdateJob(BaseApi):
    ...
    def slurm_v0039_update_job(
        ...
        return self._slurm_v0039_update_job_oapg(
            body=body,
