...
SchemaFor200ResponseBodyApplicationJson = Dbv0037ConfigInfo
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037ConfigInfo
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_get_db_config_oapg(
        self,
...
class SlurmdbdGetDbConfig(BaseApi):
    ...
    def slurmdbd_get_db_config(
        ...
        return self._slurmdbd_get_db_config_oapg(
