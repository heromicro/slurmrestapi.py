...
SchemaFor200ResponseBodyApplicationJson = Dbv0037ConfigResponse
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037ConfigResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_set_db_config_oapg(
        self,
...
class SlurmdbdSetDbConfig(BaseApi):
    ...
    def slurmdbd_set_db_config(
        ...
        return self._slurmdbd_set_db_config_oapg(
