...
SchemaFor200ResponseBodyApplicationJson = Dbv0037ClusterInfo
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037ClusterInfo
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_get_clusters_oapg(
        self,
...
class SlurmdbdGetClusters(BaseApi):
    ...
    def slurmdbd_get_clusters(
        ...
        return self._slurmdbd_get_clusters_oapg(
