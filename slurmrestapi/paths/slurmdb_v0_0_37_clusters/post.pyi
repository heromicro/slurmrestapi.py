...
SchemaFor200ResponseBodyApplicationJson = Dbv0037ResponseClusterAdd
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037ResponseClusterAdd
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_add_clusters_oapg(
        self,
...
class SlurmdbdAddClusters(BaseApi):
    ...
    def slurmdbd_add_clusters(
        ...
        return self._slurmdbd_add_clusters_oapg(
