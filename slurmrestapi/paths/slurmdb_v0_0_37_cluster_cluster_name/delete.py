...
SchemaFor200ResponseBodyApplicationJson = Dbv0037ResponseClusterDelete
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037ResponseClusterDelete
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_delete_cluster_oapg(
        self,
...
class SlurmdbdDeleteCluster(BaseApi):
    ...
    def slurmdbd_delete_cluster(
        ...
        return self._slurmdbd_delete_cluster_oapg(
