...
SchemaFor200ResponseBodyApplicationJson = Dbv0037ResponseWckeyAdd
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037ResponseWckeyAdd
...
class SlurmdbdAddWckeys(BaseApi):
    ...
    def slurmdbd_add_wckeys(
        ...
        return self._slurmdbd_add_wckeys_oapg(
