...
SchemaFor200ResponseBodyApplicationJson = Dbv0037ResponseUserUpdate
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037ResponseUserUpdate
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_update_users_oapg(
        self,
...
class SlurmdbdUpdateUsers(BaseApi):
    ...
    def slurmdbd_update_users(
        ...
        return self._slurmdbd_update_users_oapg(
