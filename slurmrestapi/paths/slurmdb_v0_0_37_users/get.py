...
SchemaFor200ResponseBodyApplicationJson = Dbv0037UserInfo
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037UserInfo
...
class SlurmdbdGetUsers(BaseApi):
    ...
    def slurmdbd_get_users(
        ...
        return self._slurmdbd_get_users_oapg(
