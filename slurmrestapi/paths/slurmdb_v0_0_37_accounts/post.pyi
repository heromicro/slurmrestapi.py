...
SchemaFor200ResponseBodyApplicationJson = Dbv0037AccountResponse
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037AccountResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_update_account_oapg(
        self,
...
class SlurmdbdUpdateAccount(BaseApi):
    ...
    def slurmdbd_update_account(
        ...
        return self._slurmdbd_update_account_oapg(
