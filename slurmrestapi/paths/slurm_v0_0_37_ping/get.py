...
SchemaFor200ResponseBodyApplicationJson = V0037Pings
SchemaFor200ResponseBodyApplicationXYaml = V0037Pings
...
class SlurmctldPing(BaseApi):
    ...
    def slurmctld_ping(
        ...
        return self._slurmctld_ping_oapg(
