...
SchemaFor200ResponseBodyApplicationJson = Dbv0037ResponseTres
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037ResponseTres
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_update_tres_oapg(
        self,
...
class SlurmdbdUpdateTres(BaseApi):
    ...
    def slurmdbd_update_tres(
        ...
        return self._slurmdbd_update_tres_oapg(
