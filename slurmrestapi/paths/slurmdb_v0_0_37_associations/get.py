...
SchemaFor200ResponseBodyApplicationJson = Dbv0037AssociationsInfo
SchemaFor200ResponseBodyApplicationXYaml = Dbv0037AssociationsInfo
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slurmdbd_get_associations_oapg(
        self,
...
class SlurmdbdGetAssociations(BaseApi):
    ...
    def slurmdbd_get_associations(
        ...
        return self._slurmdbd_get_associations_oapg(
