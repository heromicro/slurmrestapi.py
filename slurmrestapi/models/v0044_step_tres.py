...
class V0044StepTres(BaseModel):
    """
    V0044StepTres
    """ # noqa: E501
    requested: Optional[V0044StepTresRequested] = None
    consumed: Optional[V0044StepTresConsumed] = None
    allocated: Optional[List[V0044Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requested": V0044StepTresRequested.from_dict(obj["requested"]) if obj.get("requested") is not None else None,
            "consumed": V0044StepTresConsumed.from_dict(obj["consumed"]) if obj.get("consumed") is not None else None,
            "allocated": [V0044Tres.from_dict(_item) for _item in obj["allocated"]] if obj.get("allocated") is not None else None
        })
        return _obj
