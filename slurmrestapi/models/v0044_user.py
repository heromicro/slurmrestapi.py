...
class V0044User(BaseModel):
    """
    V0044User
    """ # noqa: E501
    administrator_level: Optional[List[StrictStr]] = Field(default=None, description="AdminLevel granted to the user")
    associations: Optional[List[V0044AssocShort]] = None
    coordinators: Optional[List[V0044Coord]] = None
    default: Optional[V0044UserDefault] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "associations": [V0044AssocShort.from_dict(_item) for _item in obj["associations"]] if obj.get("associations") is not None else None,
            "coordinators": [V0044Coord.from_dict(_item) for _item in obj["coordinators"]] if obj.get("coordinators") is not None else None,
            "default": V0044UserDefault.from_dict(obj["default"]) if obj.get("default") is not None else None,
            "flags": obj.get("flags"),
            "name": obj.get("name"),
