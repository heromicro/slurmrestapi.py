...
class V0044JobAllocReq(BaseModel):
    """
    V0044JobAllocReq
    """ # noqa: E501
    hetjob: Optional[List[V0044JobDescMsg]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hetjob": [V0044JobDescMsg.from_dict(_item) for _item in obj["hetjob"]] if obj.get("hetjob") is not None else None,
