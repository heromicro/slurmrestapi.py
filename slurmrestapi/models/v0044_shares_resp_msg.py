...
class V0044SharesRespMsg(BaseModel):
    """
    V0044SharesRespMsg
    """ # noqa: E501
    shares: Optional[List[V0044AssocSharesObjWrap]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shares": [V0044AssocSharesObjWrap.from_dict(_item) for _item in obj["shares"]] if obj.get("shares") is not None else None,
