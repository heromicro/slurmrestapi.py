...
class V0044AssocMax(BaseModel):
    """
    V0044AssocMax
    """ # noqa: E501
    jobs: Optional[V0044AssocMaxJobs] = None
    tres: Optional[V0044AssocMaxTres] = None
    per: Optional[V0044AssocMaxPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": V0044AssocMaxJobs.from_dict(obj["jobs"]) if obj.get("jobs") is not None else None,
            "tres": V0044AssocMaxTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "per": V0044AssocMaxPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
