...
class V0044StepStatisticsEnergy(BaseModel):
    """
    V0044StepStatisticsEnergy
    """ # noqa: E501
    consumed: Optional[V0044Uint64NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consumed": V0044Uint64NoValStruct.from_dict(obj["consumed"]) if obj.get("consumed") is not None else None
        })
        return _obj
