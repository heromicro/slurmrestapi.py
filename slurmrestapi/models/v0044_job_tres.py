...
class V0044JobTres(BaseModel):
    """
    V0044JobTres
    """ # noqa: E501
    allocated: Optional[List[V0044Tres]] = None
    requested: Optional[List[V0044Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requested": [V0044Tres.from_dict(_item) for _item in obj["requested"]] if obj.get("requested") is not None else None
        })
        return _obj
