...
class V0044PartitionInfo(BaseModel):
    """
    V0044PartitionInfo
    """ # noqa: E501
    nodes: Optional[V0044PartitionInfoNodes] = None
    accounts: Optional[V0044PartitionInfoAccounts] = None
    groups: Optional[V0044PartitionInfoGroups] = None
    qos: Optional[V0044PartitionInfoQos] = None
    ...
    tres: Optional[V0044PartitionInfoTres] = None
    ...
    cpus: Optional[V0044PartitionInfoCpus] = None
    defaults: Optional[V0044PartitionInfoDefaults] = None
    ...
    maximums: Optional[V0044PartitionInfoMaximums] = None
    minimums: Optional[V0044PartitionInfoMinimums] = None
    ...
    priority: Optional[V0044PartitionInfoPriority] = None
    timeouts: Optional[V0044PartitionInfoTimeouts] = None
    ...
    suspend_time: Optional[V0044Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": V0044PartitionInfoNodes.from_dict(obj["nodes"]) if obj.get("nodes") is not None else None,
            "accounts": V0044PartitionInfoAccounts.from_dict(obj["accounts"]) if obj.get("accounts") is not None else None,
            "groups": V0044PartitionInfoGroups.from_dict(obj["groups"]) if obj.get("groups") is not None else None,
            "qos": V0044PartitionInfoQos.from_dict(obj["qos"]) if obj.get("qos") is not None else None,
            "alternate": obj.get("alternate"),
            "tres": V0044PartitionInfoTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "cluster": obj.get("cluster"),
            "select_type": obj.get("select_type"),
            "cpus": V0044PartitionInfoCpus.from_dict(obj["cpus"]) if obj.get("cpus") is not None else None,
            "defaults": V0044PartitionInfoDefaults.from_dict(obj["defaults"]) if obj.get("defaults") is not None else None,
            "grace_time": obj.get("grace_time"),
            "maximums": V0044PartitionInfoMaximums.from_dict(obj["maximums"]) if obj.get("maximums") is not None else None,
            "minimums": V0044PartitionInfoMinimums.from_dict(obj["minimums"]) if obj.get("minimums") is not None else None,
            "name": obj.get("name"),
            "node_sets": obj.get("node_sets"),
            "priority": V0044PartitionInfoPriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "timeouts": V0044PartitionInfoTimeouts.from_dict(obj["timeouts"]) if obj.get("timeouts") is not None else None,
            ...
            "suspend_time": V0044Uint32NoValStruct.from_dict(obj["suspend_time"]) if obj.get("suspend_time") is not None else None
        })
        return _obj
