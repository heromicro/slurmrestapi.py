...
class V0044QosLimitsMaxTresMinutes(BaseModel):
    """
    V0044QosLimitsMaxTresMinutes
    """ # noqa: E501
    total: Optional[List[V0044Tres]] = None
    per: Optional[V0044QosLimitsMaxTresMinutesPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "per": V0044QosLimitsMaxTresMinutesPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
