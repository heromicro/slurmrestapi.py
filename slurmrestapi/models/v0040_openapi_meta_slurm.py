...
class V0040OpenapiMetaSlurm(BaseModel):
    """
    V0040OpenapiMetaSlurm
    """ # noqa: E501
    version: Optional[V0040OpenapiMetaSlurmVersion] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "version": V0040OpenapiMetaSlurmVersion.from_dict(obj["version"]) if obj.get("version") is not None else None,
