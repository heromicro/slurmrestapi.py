...
class V0044KillJobsRespJob(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": V0041OpenapiKillJobsRespStatusInnerError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "step_id": obj.get("step_id"),
            "job_id": V0044Uint32NoValStruct.from_dict(obj["job_id"]) if obj.get("job_id") is not None else None,
            "federation": V0041OpenapiKillJobsRespStatusInnerFederation.from_dict(obj["federation"]) if obj.get("federation") is not None else None
        })
        return _obj
