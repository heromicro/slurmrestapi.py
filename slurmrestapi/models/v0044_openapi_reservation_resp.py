...
class V0044OpenapiReservationResp(BaseModel):
    """
    V0044OpenapiReservationResp
    """ # noqa: E501
    reservations: List[V0044ReservationInfo]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reservations": [V0044ReservationInfo.from_dict(_item) for _item in obj["reservations"]] if obj.get("reservations") is not None else None,
