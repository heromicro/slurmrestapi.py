...
class V0044AssocRecSet(BaseModel):
    """
    V0044AssocRecSet
    """ # noqa: E501
    ...
    grpjobs: Optional[V0044Uint32NoValStruct] = None
    grpjobsaccrue: Optional[V0044Uint32NoValStruct] = None
    grpsubmitjobs: Optional[V0044Uint32NoValStruct] = None
    grptres: Optional[List[V0044Tres]] = None
    grptresmins: Optional[List[V0044Tres]] = None
    grptresrunmins: Optional[List[V0044Tres]] = None
    grpwall: Optional[V0044Uint32NoValStruct] = None
    maxjobs: Optional[V0044Uint32NoValStruct] = None
    maxjobsaccrue: Optional[V0044Uint32NoValStruct] = None
    maxsubmitjobs: Optional[V0044Uint32NoValStruct] = None
    maxtresminsperjob: Optional[List[V0044Tres]] = None
    maxtresrunmins: Optional[List[V0044Tres]] = None
    maxtresperjob: Optional[List[V0044Tres]] = None
    maxtrespernode: Optional[List[V0044Tres]] = None
    maxwalldurationperjob: Optional[V0044Uint32NoValStruct] = None
    minpriothresh: Optional[V0044Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "grpjobs": V0044Uint32NoValStruct.from_dict(obj["grpjobs"]) if obj.get("grpjobs") is not None else None,
            "grpjobsaccrue": V0044Uint32NoValStruct.from_dict(obj["grpjobsaccrue"]) if obj.get("grpjobsaccrue") is not None else None,
            "grpsubmitjobs": V0044Uint32NoValStruct.from_dict(obj["grpsubmitjobs"]) if obj.get("grpsubmitjobs") is not None else None,
            "grptres": [V0044Tres.from_dict(_item) for _item in obj["grptres"]] if obj.get("grptres") is not None else None,
            "grptresmins": [V0044Tres.from_dict(_item) for _item in obj["grptresmins"]] if obj.get("grptresmins") is not None else None,
            "grptresrunmins": [V0044Tres.from_dict(_item) for _item in obj["grptresrunmins"]] if obj.get("grptresrunmins") is not None else None,
            "grpwall": V0044Uint32NoValStruct.from_dict(obj["grpwall"]) if obj.get("grpwall") is not None else None,
            "maxjobs": V0044Uint32NoValStruct.from_dict(obj["maxjobs"]) if obj.get("maxjobs") is not None else None,
            "maxjobsaccrue": V0044Uint32NoValStruct.from_dict(obj["maxjobsaccrue"]) if obj.get("maxjobsaccrue") is not None else None,
            "maxsubmitjobs": V0044Uint32NoValStruct.from_dict(obj["maxsubmitjobs"]) if obj.get("maxsubmitjobs") is not None else None,
            "maxtresminsperjob": [V0044Tres.from_dict(_item) for _item in obj["maxtresminsperjob"]] if obj.get("maxtresminsperjob") is not None else None,
            "maxtresrunmins": [V0044Tres.from_dict(_item) for _item in obj["maxtresrunmins"]] if obj.get("maxtresrunmins") is not None else None,
            "maxtresperjob": [V0044Tres.from_dict(_item) for _item in obj["maxtresperjob"]] if obj.get("maxtresperjob") is not None else None,
            "maxtrespernode": [V0044Tres.from_dict(_item) for _item in obj["maxtrespernode"]] if obj.get("maxtrespernode") is not None else None,
            "maxwalldurationperjob": V0044Uint32NoValStruct.from_dict(obj["maxwalldurationperjob"]) if obj.get("maxwalldurationperjob") is not None else None,
            "minpriothresh": V0044Uint32NoValStruct.from_dict(obj["minpriothresh"]) if obj.get("minpriothresh") is not None else None,
