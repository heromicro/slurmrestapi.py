...
class V0044Step(BaseModel):
    """
    V0044Step
    """ # noqa: E501
    time: Optional[V0044StepTime] = None
    exit_code: Optional[V0044ProcessExitCodeVerbose] = None
    nodes: Optional[V0044StepNodes] = None
    ...
    cpu: Optional[V0044StepCPU] = Field(default=None, alias="CPU")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "time": V0044StepTime.from_dict(obj["time"]) if obj.get("time") is not None else None,
            "exit_code": V0044ProcessExitCodeVerbose.from_dict(obj["exit_code"]) if obj.get("exit_code") is not None else None,
            "nodes": V0044StepNodes.from_dict(obj["nodes"]) if obj.get("nodes") is not None else None,
            "tasks": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTasks.from_dict(obj["tasks"]) if obj.get("tasks") is not None else None,
            "pid": obj.get("pid"),
            "CPU": V0044StepCPU.from_dict(obj["CPU"]) if obj.get("CPU") is not None else None,
            "kill_request_user": obj.get("kill_request_user"),
            "state": obj.get("state"),
            "statistics": V0044StepStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
            ...
            "tres": V0044StepTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None
        })
        return _obj
