...
class V0044JobResSocket(BaseModel):
    """
    V0044JobResSocket
    """ # noqa: E501
    index: StrictInt = Field(description="Core index")
    cores: List[V0044JobResCore]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "cores": [V0044JobResCore.from_dict(_item) for _item in obj["cores"]] if obj.get("cores") is not None else None
        })
        return _obj
