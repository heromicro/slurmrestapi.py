...
class V0041OpenapiSlurmdbdStatsRespStatisticsRollupsMonthly(BaseModel):
    """
    ...
    duration: Optional[V0041OpenapiSlurmdbdStatsRespStatisticsRollupsMonthlyDuration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "duration": V0041OpenapiSlurmdbdStatsRespStatisticsRollupsMonthlyDuration.from_dict(obj["duration"]) if obj.get("duration") is not None else None
        })
        return _obj
