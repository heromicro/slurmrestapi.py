...
class V0044JobInfo(BaseModel):
    ...
    array_job_id: Optional[V0044Uint32NoValStruct] = None
    array_task_id: Optional[V0044Uint32NoValStruct] = None
    array_max_tasks: Optional[V0044Uint32NoValStruct] = None
    ...
    cores_per_socket: Optional[V0044Uint16NoValStruct] = None
    billable_tres: Optional[V0044Float64NoValStruct] = None
    cpus_per_task: Optional[V0044Uint16NoValStruct] = None
    cpu_frequency_minimum: Optional[V0044Uint32NoValStruct] = None
    cpu_frequency_maximum: Optional[V0044Uint32NoValStruct] = None
    cpu_frequency_governor: Optional[V0044Uint32NoValStruct] = None
    ...
    deadline: Optional[V0044Uint64NoValStruct] = None
    delay_boot: Optional[V0044Uint32NoValStruct] = None
    ...
    eligible_time: Optional[V0044Uint64NoValStruct] = None
    ...
    exit_code: Optional[V0044ProcessExitCodeVerbose] = None
    ...
    max_cpus: Optional[V0044Uint32NoValStruct] = None
    max_nodes: Optional[V0044Uint32NoValStruct] = None
    ...
    tasks_per_core: Optional[V0044Uint16NoValStruct] = None
    tasks_per_tres: Optional[V0044Uint16NoValStruct] = None
    tasks_per_node: Optional[V0044Uint16NoValStruct] = None
    tasks_per_socket: Optional[V0044Uint16NoValStruct] = None
    tasks_per_board: Optional[V0044Uint16NoValStruct] = None
    cpus: Optional[V0044Uint32NoValStruct] = None
    node_count: Optional[V0044Uint32NoValStruct] = None
    tasks: Optional[V0044Uint32NoValStruct] = None
    ...
    memory_per_cpu: Optional[V0044Uint64NoValStruct] = None
    memory_per_node: Optional[V0044Uint64NoValStruct] = None
    minimum_cpus_per_node: Optional[V0044Uint16NoValStruct] = None
    minimum_tmp_disk_per_node: Optional[V0044Uint32NoValStruct] = None
    power: Optional[V0041OpenapiJobInfoRespJobsInnerPower] = None
    preempt_time: Optional[V0044Uint64NoValStruct] = None
    preemptable_time: Optional[V0044Uint64NoValStruct] = None
    pre_sus_time: Optional[V0044Uint64NoValStruct] = None
    hold: Optional[StrictBool] = Field(default=None, description="Hold (true) or release (false) job (Job held)")
    priority: Optional[V0044Uint32NoValStruct] = None
    priority_by_partition: Optional[List[V0044PartPrio]] = None
    ...
    resize_time: Optional[V0044Uint64NoValStruct] = None
    ...
    submit_time: Optional[V0044Uint64NoValStruct] = None
    submit_line: Optional[StrictStr] = Field(default=None, description="Job submit line (e.g. 'sbatch -N3 job.sh job_arg'")
    suspend_time: Optional[V0044Uint64NoValStruct] = None
    system_comment: Optional[StrictStr] = Field(default=None, description="Arbitrary comment from slurmctld")
    time_limit: Optional[V0044Uint32NoValStruct] = None
    time_minimum: Optional[V0044Uint32NoValStruct] = None
    threads_per_core: Optional[V0044Uint16NoValStruct] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of step_id
        if self.step_id:
            _dict['step_id'] = self.step_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accrue_time": V0044Uint64NoValStruct.from_dict(obj["accrue_time"]) if obj.get("accrue_time") is not None else None,
            "admin_comment": obj.get("admin_comment"),
            "allocating_node": obj.get("allocating_node"),
            "array_job_id": V0044Uint32NoValStruct.from_dict(obj["array_job_id"]) if obj.get("array_job_id") is not None else None,
            "array_task_id": V0044Uint32NoValStruct.from_dict(obj["array_task_id"]) if obj.get("array_task_id") is not None else None,
            "array_max_tasks": V0044Uint32NoValStruct.from_dict(obj["array_max_tasks"]) if obj.get("array_max_tasks") is not None else None,
            ...
            "cores_per_socket": V0044Uint16NoValStruct.from_dict(obj["cores_per_socket"]) if obj.get("cores_per_socket") is not None else None,
            "billable_tres": V0044Float64NoValStruct.from_dict(obj["billable_tres"]) if obj.get("billable_tres") is not None else None,
            "cpus_per_task": V0044Uint16NoValStruct.from_dict(obj["cpus_per_task"]) if obj.get("cpus_per_task") is not None else None,
            "cpu_frequency_minimum": V0044Uint32NoValStruct.from_dict(obj["cpu_frequency_minimum"]) if obj.get("cpu_frequency_minimum") is not None else None,
            "cpu_frequency_maximum": V0044Uint32NoValStruct.from_dict(obj["cpu_frequency_maximum"]) if obj.get("cpu_frequency_maximum") is not None else None,
            "cpu_frequency_governor": V0044Uint32NoValStruct.from_dict(obj["cpu_frequency_governor"]) if obj.get("cpu_frequency_governor") is not None else None,
            "cpus_per_tres": obj.get("cpus_per_tres"),
            "cron": obj.get("cron"),
            "deadline": V0044Uint64NoValStruct.from_dict(obj["deadline"]) if obj.get("deadline") is not None else None,
            "delay_boot": V0044Uint32NoValStruct.from_dict(obj["delay_boot"]) if obj.get("delay_boot") is not None else None,
            ...
            "eligible_time": V0044Uint64NoValStruct.from_dict(obj["eligible_time"]) if obj.get("eligible_time") is not None else None,
            ...
            "exit_code": V0044ProcessExitCodeVerbose.from_dict(obj["exit_code"]) if obj.get("exit_code") is not None else None,
            "extra": obj.get("extra"),
            ...
            "het_job_id": V0044Uint32NoValStruct.from_dict(obj["het_job_id"]) if obj.get("het_job_id") is not None else None,
            "het_job_id_set": obj.get("het_job_id_set"),
            "het_job_offset": V0044Uint32NoValStruct.from_dict(obj["het_job_offset"]) if obj.get("het_job_offset") is not None else None,
            "job_id": obj.get("job_id"),
            "job_resources": V0044JobRes.from_dict(obj["job_resources"]) if obj.get("job_resources") is not None else None,
            "job_size_str": obj.get("job_size_str"),
            "job_state": obj.get("job_state"),
            "last_sched_evaluation": V0044Uint64NoValStruct.from_dict(obj["last_sched_evaluation"]) if obj.get("last_sched_evaluation") is not None else None,
            ...
            "max_cpus": V0044Uint32NoValStruct.from_dict(obj["max_cpus"]) if obj.get("max_cpus") is not None else None,
            "max_nodes": V0044Uint32NoValStruct.from_dict(obj["max_nodes"]) if obj.get("max_nodes") is not None else None,
            ...
            "nodes": obj.get("nodes"),
            "nice": obj.get("nice"),
            "tasks_per_core": V0044Uint16NoValStruct.from_dict(obj["tasks_per_core"]) if obj.get("tasks_per_core") is not None else None,
            "tasks_per_tres": V0044Uint16NoValStruct.from_dict(obj["tasks_per_tres"]) if obj.get("tasks_per_tres") is not None else None,
            "tasks_per_node": V0044Uint16NoValStruct.from_dict(obj["tasks_per_node"]) if obj.get("tasks_per_node") is not None else None,
            "tasks_per_socket": V0044Uint16NoValStruct.from_dict(obj["tasks_per_socket"]) if obj.get("tasks_per_socket") is not None else None,
            "tasks_per_board": V0044Uint16NoValStruct.from_dict(obj["tasks_per_board"]) if obj.get("tasks_per_board") is not None else None,
            "cpus": V0044Uint32NoValStruct.from_dict(obj["cpus"]) if obj.get("cpus") is not None else None,
            "node_count": V0044Uint32NoValStruct.from_dict(obj["node_count"]) if obj.get("node_count") is not None else None,
            "tasks": V0044Uint32NoValStruct.from_dict(obj["tasks"]) if obj.get("tasks") is not None else None,
            "partition": obj.get("partition"),
            "prefer": obj.get("prefer"),
            "memory_per_cpu": V0044Uint64NoValStruct.from_dict(obj["memory_per_cpu"]) if obj.get("memory_per_cpu") is not None else None,
            "memory_per_node": V0044Uint64NoValStruct.from_dict(obj["memory_per_node"]) if obj.get("memory_per_node") is not None else None,
            "minimum_cpus_per_node": V0044Uint16NoValStruct.from_dict(obj["minimum_cpus_per_node"]) if obj.get("minimum_cpus_per_node") is not None else None,
            "minimum_tmp_disk_per_node": V0044Uint32NoValStruct.from_dict(obj["minimum_tmp_disk_per_node"]) if obj.get("minimum_tmp_disk_per_node") is not None else None,
            "power": V0041OpenapiJobInfoRespJobsInnerPower.from_dict(obj["power"]) if obj.get("power") is not None else None,
            "preempt_time": V0044Uint64NoValStruct.from_dict(obj["preempt_time"]) if obj.get("preempt_time") is not None else None,
            "preemptable_time": V0044Uint64NoValStruct.from_dict(obj["preemptable_time"]) if obj.get("preemptable_time") is not None else None,
            "pre_sus_time": V0044Uint64NoValStruct.from_dict(obj["pre_sus_time"]) if obj.get("pre_sus_time") is not None else None,
            "hold": obj.get("hold"),
            "priority": V0044Uint32NoValStruct.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "priority_by_partition": [V0044PartPrio.from_dict(_item) for _item in obj["priority_by_partition"]] if obj.get("priority_by_partition") is not None else None,
            ...
            "resize_time": V0044Uint64NoValStruct.from_dict(obj["resize_time"]) if obj.get("resize_time") is not None else None,
            ...
            "step_id": V0044SlurmStepId.from_dict(obj["step_id"]) if obj.get("step_id") is not None else None,
            "sockets_per_board": obj.get("sockets_per_board"),
            "sockets_per_node": V0044Uint16NoValStruct.from_dict(obj["sockets_per_node"]) if obj.get("sockets_per_node") is not None else None,
            ...
            "submit_time": V0044Uint64NoValStruct.from_dict(obj["submit_time"]) if obj.get("submit_time") is not None else None,
            "submit_line": obj.get("submit_line"),
            "suspend_time": V0044Uint64NoValStruct.from_dict(obj["suspend_time"]) if obj.get("suspend_time") is not None else None,
            "system_comment": obj.get("system_comment"),
            "time_limit": V0044Uint32NoValStruct.from_dict(obj["time_limit"]) if obj.get("time_limit") is not None else None,
            "time_minimum": V0044Uint32NoValStruct.from_dict(obj["time_minimum"]) if obj.get("time_minimum") is not None else None,
            "threads_per_core": V0044Uint16NoValStruct.from_dict(obj["threads_per_core"]) if obj.get("threads_per_core") is not None else None,
