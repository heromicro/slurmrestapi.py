...
class V0044JobDescMsg(BaseModel):
    """
    V0044JobDescMsg
    """ # noqa: E501
    ...
    begin_time: Optional[V0044Uint64NoValStruct] = None
    ...
    crontab: Optional[V0044CronEntry] = None
    ...
    rlimits: Optional[V0044JobDescMsgRlimits] = None
    ...
    distribution_plane_size: Optional[V0044Uint16NoValStruct] = None
    ...
    kill_warning_delay: Optional[V0044Uint16NoValStruct] = None
    ...
    required_switches: Optional[V0044Uint32NoValStruct] = None
    segment_size: Optional[V0044Uint16NoValStruct] = None
    ...
    def memory_binding_type_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['NONE', 'RANK', 'MAP', 'MASK', 'LOCAL', 'VERBOSE', 'PREFER']):
                raise ValueError("each list item must be one of ('NONE', 'RANK', 'MAP', 'MASK', 'LOCAL', 'VERBOSE', 'PREFER')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "begin_time": V0044Uint64NoValStruct.from_dict(obj["begin_time"]) if obj.get("begin_time") is not None else None,
            "flags": obj.get("flags"),
            ...
            "crontab": V0044CronEntry.from_dict(obj["crontab"]) if obj.get("crontab") is not None else None,
            "deadline": obj.get("deadline"),
            "delay_boot": obj.get("delay_boot"),
            "dependency": obj.get("dependency"),
            "end_time": obj.get("end_time"),
            "environment": obj.get("environment"),
            "rlimits": V0044JobDescMsgRlimits.from_dict(obj["rlimits"]) if obj.get("rlimits") is not None else None,
            ...
            "distribution_plane_size": V0044Uint16NoValStruct.from_dict(obj["distribution_plane_size"]) if obj.get("distribution_plane_size") is not None else None,
            ...
            "kill_warning_delay": V0044Uint16NoValStruct.from_dict(obj["kill_warning_delay"]) if obj.get("kill_warning_delay") is not None else None,
            ...
            "required_switches": V0044Uint32NoValStruct.from_dict(obj["required_switches"]) if obj.get("required_switches") is not None else None,
            "segment_size": V0044Uint16NoValStruct.from_dict(obj["segment_size"]) if obj.get("segment_size") is not None else None,
