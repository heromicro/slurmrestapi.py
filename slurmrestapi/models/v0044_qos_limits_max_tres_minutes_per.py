...
class V0044QosLimitsMaxTresMinutesPer(BaseModel):
    """
    V0044QosLimitsMaxTresMinutesPer
    """ # noqa: E501
    qos: Optional[List[V0044Tres]] = None
    job: Optional[List[V0044Tres]] = None
    account: Optional[List[V0044Tres]] = None
    user: Optional[List[V0044Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qos": [V0044Tres.from_dict(_item) for _item in obj["qos"]] if obj.get("qos") is not None else None,
            "job": [V0044Tres.from_dict(_item) for _item in obj["job"]] if obj.get("job") is not None else None,
            "account": [V0044Tres.from_dict(_item) for _item in obj["account"]] if obj.get("account") is not None else None,
            "user": [V0044Tres.from_dict(_item) for _item in obj["user"]] if obj.get("user") is not None else None
        })
        return _obj
