...
class V0044AssocMaxTresGroup(BaseModel):
    """
    V0044AssocMaxTresGroup
    """ # noqa: E501
    minutes: Optional[List[V0044Tres]] = None
    active: Optional[List[V0044Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minutes": [V0044Tres.from_dict(_item) for _item in obj["minutes"]] if obj.get("minutes") is not None else None,
            "active": [V0044Tres.from_dict(_item) for _item in obj["active"]] if obj.get("active") is not None else None
        })
        return _obj
