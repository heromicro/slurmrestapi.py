...
class V0044AssocSharesObjWrapTres(BaseModel):
    """
    V0044AssocSharesObjWrapTres
    """ # noqa: E501
    run_seconds: Optional[List[V0044SharesUint64Tres]] = None
    group_minutes: Optional[List[V0044SharesUint64Tres]] = None
    usage: Optional[List[V0044SharesFloat128Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "run_seconds": [V0044SharesUint64Tres.from_dict(_item) for _item in obj["run_seconds"]] if obj.get("run_seconds") is not None else None,
            "group_minutes": [V0044SharesUint64Tres.from_dict(_item) for _item in obj["group_minutes"]] if obj.get("group_minutes") is not None else None,
            "usage": [V0044SharesFloat128Tres.from_dict(_item) for _item in obj["usage"]] if obj.get("usage") is not None else None
        })
        return _obj
