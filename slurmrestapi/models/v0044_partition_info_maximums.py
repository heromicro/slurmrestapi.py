...
class V0044PartitionInfoMaximums(BaseModel):
    """
    V0044PartitionInfoMaximums
    """ # noqa: E501
    cpus_per_node: Optional[V0044Uint32NoValStruct] = None
    cpus_per_socket: Optional[V0044Uint32NoValStruct] = None
    memory_per_cpu: Optional[StrictInt] = Field(default=None, description="Raw value for MaxMemPerCPU or MaxMemPerNode")
    partition_memory_per_cpu: Optional[V0044Uint64NoValStruct] = None
    partition_memory_per_node: Optional[V0044Uint64NoValStruct] = None
    nodes: Optional[V0044Uint32NoValStruct] = None
    ...
    time: Optional[V0044Uint32NoValStruct] = None
    over_time_limit: Optional[V0044Uint16NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cpus_per_node": V0044Uint32NoValStruct.from_dict(obj["cpus_per_node"]) if obj.get("cpus_per_node") is not None else None,
            "cpus_per_socket": V0044Uint32NoValStruct.from_dict(obj["cpus_per_socket"]) if obj.get("cpus_per_socket") is not None else None,
            "memory_per_cpu": obj.get("memory_per_cpu"),
            "partition_memory_per_cpu": V0044Uint64NoValStruct.from_dict(obj["partition_memory_per_cpu"]) if obj.get("partition_memory_per_cpu") is not None else None,
            "partition_memory_per_node": V0044Uint64NoValStruct.from_dict(obj["partition_memory_per_node"]) if obj.get("partition_memory_per_node") is not None else None,
            "nodes": V0044Uint32NoValStruct.from_dict(obj["nodes"]) if obj.get("nodes") is not None else None,
            ...
            "time": V0044Uint32NoValStruct.from_dict(obj["time"]) if obj.get("time") is not None else None,
            "over_time_limit": V0044Uint16NoValStruct.from_dict(obj["over_time_limit"]) if obj.get("over_time_limit") is not None else None
        })
        return _obj
