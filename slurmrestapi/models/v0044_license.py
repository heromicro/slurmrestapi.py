...
class V0044License(BaseModel):
    ...
    nodes: Optional[StrictStr] = Field(default=None, description="HRes nodes", alias="Nodes")
    __properties: ClassVar[List[str]] = ["LicenseName", "Total", "Used", "Free", "Remote", "Reserved", "LastConsumed", "LastDeficit", "LastUpdate", "Nodes"]
