...
class V0044AssocMaxTresMinutes(BaseModel):
    """
    V0044AssocMaxTresMinutes
    """ # noqa: E501
    total: Optional[List[V0044Tres]] = None
    per: Optional[V0044QosLimitsMinTresPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "per": V0044QosLimitsMinTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
