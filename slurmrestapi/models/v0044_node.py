...
class V0044Node(BaseModel):
    ...
    boot_time: Optional[V0044Uint64NoValStruct] = None
    tls_cert_last_renewal: Optional[V0044Uint64NoValStruct] = None
    ...
    free_mem: Optional[V0044Uint64NoValStruct] = None
    ...
    energy: Optional[V0044AcctGatherEnergy] = None
    ...
    last_busy: Optional[V0044Uint64NoValStruct] = None
    ...
    reason_changed_at: Optional[V0044Uint64NoValStruct] = None
    reason_set_by_user: Optional[StrictStr] = Field(default=None, description="User who set the reason")
    resume_after: Optional[V0044Uint64NoValStruct] = None
    ...
    slurmd_start_time: Optional[V0044Uint64NoValStruct] = None
    ...
    def next_state_after_reboot_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['INVALID', 'UNKNOWN', 'DOWN', 'IDLE', 'ALLOCATED', 'ERROR', 'MIXED', 'FUTURE', 'EXTERNAL', 'RESERVED', 'UNDRAIN', 'CLOUD', 'RESUME', 'DRAIN', 'COMPLETING', 'NOT_RESPONDING', 'POWERED_DOWN', 'FAIL', 'POWERING_UP', 'MAINTENANCE', 'REBOOT_REQUESTED', 'REBOOT_CANCELED', 'POWERING_DOWN', 'DYNAMIC_FUTURE', 'REBOOT_ISSUED', 'PLANNED', 'INVALID_REG', 'POWER_DOWN', 'POWER_UP', 'POWER_DRAIN', 'DYNAMIC_NORM', 'BLOCKED']):
                raise ValueError("each list item must be one of ('INVALID', 'UNKNOWN', 'DOWN', 'IDLE', 'ALLOCATED', 'ERROR', 'MIXED', 'FUTURE', 'EXTERNAL', 'RESERVED', 'UNDRAIN', 'CLOUD', 'RESUME', 'DRAIN', 'COMPLETING', 'NOT_RESPONDING', 'POWERED_DOWN', 'FAIL', 'POWERING_UP', 'MAINTENANCE', 'REBOOT_REQUESTED', 'REBOOT_CANCELED', 'POWERING_DOWN', 'DYNAMIC_FUTURE', 'REBOOT_ISSUED', 'PLANNED', 'INVALID_REG', 'POWER_DOWN', 'POWER_UP', 'POWER_DRAIN', 'DYNAMIC_NORM', 'BLOCKED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "boot_time": V0044Uint64NoValStruct.from_dict(obj["boot_time"]) if obj.get("boot_time") is not None else None,
            "tls_cert_last_renewal": V0044Uint64NoValStruct.from_dict(obj["tls_cert_last_renewal"]) if obj.get("tls_cert_last_renewal") is not None else None,
            ...
            "free_mem": V0044Uint64NoValStruct.from_dict(obj["free_mem"]) if obj.get("free_mem") is not None else None,
            "cpus": obj.get("cpus"),
            "effective_cpus": obj.get("effective_cpus"),
            "specialized_cpus": obj.get("specialized_cpus"),
            "energy": V0044AcctGatherEnergy.from_dict(obj["energy"]) if obj.get("energy") is not None else None,
            ...
            "last_busy": V0044Uint64NoValStruct.from_dict(obj["last_busy"]) if obj.get("last_busy") is not None else None,
            ...
            "reason_changed_at": V0044Uint64NoValStruct.from_dict(obj["reason_changed_at"]) if obj.get("reason_changed_at") is not None else None,
            "reason_set_by_user": obj.get("reason_set_by_user"),
            "resume_after": V0044Uint64NoValStruct.from_dict(obj["resume_after"]) if obj.get("resume_after") is not None else None,
            ...
            "slurmd_start_time": V0044Uint64NoValStruct.from_dict(obj["slurmd_start_time"]) if obj.get("slurmd_start_time") is not None else None,
