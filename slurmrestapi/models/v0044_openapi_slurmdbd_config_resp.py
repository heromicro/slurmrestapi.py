...
class V0044OpenapiSlurmdbdConfigResp(BaseModel):
    """
    V0044OpenapiSlurmdbdConfigResp
    """ # noqa: E501
    clusters: Optional[List[V0044ClusterRec]] = None
    tres: Optional[List[V0044Tres]] = None
    accounts: Optional[List[V0044Account]] = None
    users: Optional[List[V0044User]] = None
    qos: Optional[List[V0044Qos]] = None
    wckeys: Optional[List[V0044Wckey]] = None
    associations: Optional[List[V0044Assoc]] = None
    instances: Optional[List[V0044Instance]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusters": [V0044ClusterRec.from_dict(_item) for _item in obj["clusters"]] if obj.get("clusters") is not None else None,
            "tres": [V0044Tres.from_dict(_item) for _item in obj["tres"]] if obj.get("tres") is not None else None,
            "accounts": [V0044Account.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None,
            "users": [V0044User.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
            "qos": [V0044Qos.from_dict(_item) for _item in obj["qos"]] if obj.get("qos") is not None else None,
            "wckeys": [V0044Wckey.from_dict(_item) for _item in obj["wckeys"]] if obj.get("wckeys") is not None else None,
            "associations": [V0044Assoc.from_dict(_item) for _item in obj["associations"]] if obj.get("associations") is not None else None,
            "instances": [V0044Instance.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None,
