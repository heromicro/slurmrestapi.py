...
class V0044QosLimitsMaxTres(BaseModel):
    """
    V0044QosLimitsMaxTres
    """ # noqa: E501
    total: Optional[List[V0044Tres]] = None
    minutes: Optional[V0044QosLimitsMaxTresMinutes] = None
    per: Optional[V0044QosLimitsMaxTresPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minutes": V0044QosLimitsMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "per": V0044QosLimitsMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
