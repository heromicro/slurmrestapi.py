...
class V0044Assoc(BaseModel):
    """
    V0044Assoc
    """ # noqa: E501
    accounting: Optional[List[V0044Accounting]] = None
    ...
    max: Optional[V0044AssocMax] = None
    ...
    min: Optional[V0044AssocMin] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounting": [V0044Accounting.from_dict(_item) for _item in obj["accounting"]] if obj.get("accounting") is not None else None,
            ...
            "flags": obj.get("flags"),
            "max": V0044AssocMax.from_dict(obj["max"]) if obj.get("max") is not None else None,
            "id": obj.get("id"),
            "is_default": obj.get("is_default"),
            "lineage": obj.get("lineage"),
            "min": V0044AssocMin.from_dict(obj["min"]) if obj.get("min") is not None else None,
