...
class V0044ClusterRec(BaseModel):
    """
    V0044ClusterRec
    """ # noqa: E501
    ...
    associations: Optional[V0044ClusterRecAssociations] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "associations": V0044ClusterRecAssociations.from_dict(obj["associations"]) if obj.get("associations") is not None else None,
