...
class V0044UpdateNodeMsg(BaseModel):
    """
    V0044UpdateNodeMsg
    """ # noqa: E501
    ...
    resume_after: Optional[V0044Uint32NoValStruct] = None
    topology_str: Optional[StrictStr] = Field(default=None, description="Topology")
    weight: Optional[V0044Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resume_after": V0044Uint32NoValStruct.from_dict(obj["resume_after"]) if obj.get("resume_after") is not None else None,
            "topology_str": obj.get("topology_str"),
            "weight": V0044Uint32NoValStruct.from_dict(obj["weight"]) if obj.get("weight") is not None else None
        })
        return _obj
