...
class V0041OpenapiSharesRespMeta(BaseModel):
    ...
    Slurm meta values
    """ # noqa: E501
    plugin: Optional[V0040OpenapiMetaPlugin] = None
    client: Optional[V0040OpenapiMetaClient] = None
    command: Optional[List[StrictStr]] = Field(default=None, description="CLI command (if applicable)")
    slurm: Optional[V0040OpenapiMetaSlurm] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plugin": V0040OpenapiMetaPlugin.from_dict(obj["plugin"]) if obj.get("plugin") is not None else None,
            "client": V0040OpenapiMetaClient.from_dict(obj["client"]) if obj.get("client") is not None else None,
            "command": obj.get("command"),
            "slurm": V0040OpenapiMetaSlurm.from_dict(obj["slurm"]) if obj.get("slurm") is not None else None
        })
        return _obj
