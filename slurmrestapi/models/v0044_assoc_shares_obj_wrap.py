...
class V0044AssocSharesObjWrap(BaseModel):
    """
    ...
    shares_normalized: Optional[V0044Float64NoValStruct] = None
    shares: Optional[V0044Uint32NoValStruct] = None
    tres: Optional[V0044AssocSharesObjWrapTres] = None
    effective_usage: Optional[V0044Float64NoValStruct] = None
    usage_normalized: Optional[V0044Float64NoValStruct] = None
    usage: Optional[StrictInt] = Field(default=None, description="Measure of tresbillableunits usage")
    fairshare: Optional[V0044AssocSharesObjWrapFairshare] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shares_normalized": V0044Float64NoValStruct.from_dict(obj["shares_normalized"]) if obj.get("shares_normalized") is not None else None,
            "shares": V0044Uint32NoValStruct.from_dict(obj["shares"]) if obj.get("shares") is not None else None,
            "tres": V0044AssocSharesObjWrapTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "effective_usage": V0044Float64NoValStruct.from_dict(obj["effective_usage"]) if obj.get("effective_usage") is not None else None,
            "usage_normalized": V0044Float64NoValStruct.from_dict(obj["usage_normalized"]) if obj.get("usage_normalized") is not None else None,
            "usage": obj.get("usage"),
            "fairshare": V0044AssocSharesObjWrapFairshare.from_dict(obj["fairshare"]) if obj.get("fairshare") is not None else None,
            "type": obj.get("type")
        })
        return _obj
