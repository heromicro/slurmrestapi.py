...
class V0044JobResNodes(BaseModel):
    """
    V0044JobResNodes
    """ # noqa: E501
    ...
    allocation: Optional[List[V0044JobResNode]] = Field(default=None, description="Job resources for a node")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": obj.get("list"),
            "whole": obj.get("whole"),
            "allocation": [V0044JobResNode.from_dict(_item) for _item in obj["allocation"]] if obj.get("allocation") is not None else None
        })
        return _obj
