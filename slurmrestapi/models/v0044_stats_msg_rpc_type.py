...
class V0044StatsMsgRpcType(BaseModel):
    """
    ...
    average_time: V0044Uint64NoValStruct
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "average_time": V0044Uint64NoValStruct.from_dict(obj["average_time"]) if obj.get("average_time") is not None else None
        })
        return _obj
