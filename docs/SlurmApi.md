...
with slurmrestapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurmrestapi.SlurmApi(api_client)
    slurm_v0041_delete_jobs_request = slurmrestapi.SlurmV0041DeleteJobsRequest() # SlurmV0041DeleteJobsRequest | Signal or cancel jobs (optional)
...
with slurmrestapi.ApiClient(configuration) as api_client:
    ...
    api_instance = slurmrestapi.SlurmApi(api_client)
    job_id = 'job_id_example' # str | Job ID
    slurm_v0041_post_job_submit_request_jobs_inner = slurmrestapi.SlurmV0041PostJobSubmitRequestJobsInner() # SlurmV0041PostJobSubmitRequestJobsInner | Job update description (optional)
...
with slurmrestapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurmrestapi.SlurmApi(api_client)
    slurm_v0041_post_job_allocate_request = slurmrestapi.SlurmV0041PostJobAllocateRequest() # SlurmV0041PostJobAllocateRequest | Job allocation description (optional)
...
with slurmrestapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurmrestapi.SlurmApi(api_client)
    slurm_v0041_post_job_submit_request = slurmrestapi.SlurmV0041PostJobSubmitRequest() # SlurmV0041PostJobSubmitRequest | Job description (optional)
